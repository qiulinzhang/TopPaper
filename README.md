...
- [1. CNN - Convolutional Neural Network](#1-cnn---convolutional-neural-network)
  ...
  * [1.10 Model Compression - Decomposition, Pruning, Quantization, KD](#110-model-compression---decomposition--pruning--quantization--kd)
...
| ArcFace         | [ArcFace: Additive Angular Margin Loss for Deep Face   Recognition](https://arxiv.org/abs/1801.07698)                                                                              |   1.3 K  | CVPR                      | 2017 | Jiankang Deng  | Imperial College London         |
...
|QIL|[Learning to Quantize Deep Networks by Optimizing Quantization Intervals with Task Loss](https://arxiv.org/abs/1808.05779)|234|CVPR|2019|Sangil Jung|Samsung|
